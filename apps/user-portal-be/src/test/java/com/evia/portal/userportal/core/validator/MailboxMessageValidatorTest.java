...
public class MailboxMessageValidatorTest {
  ...
  public static final String ERROR_INVALID_MAILBOX_LOG_NULL = "The MailboxMessage is missing";
  ...
  void validateMailboxMessage_NullMailboxMessage() {
    ...
    assertThat(errors).contains(ERROR_INVALID_MAILBOX_LOG_NULL).hasSize(1);
  }
