...
import com.evia.portal.userportal.core.repository.specification.ProfileSpecification;
import com.evia.portal.userportal.core.validator.PaymentDataValidator;
import com.evia.portal.userportal.core.validator.ProfileValidator;
...
public class ProfileService {
  ...
  public Profile getProfileById(Long id) {
    ...
    if (id == null) {
      throw new EntityNotFoundException("Enter a valid id");
    }
