...
import com.evia.portal.serviceportal.core.dto.MailboxMessageStatusDTO;
...
import com.evia.portal.serviceportal.core.repository.specification.MailboxMessageSpecification;
import com.evia.portal.serviceportal.core.validator.MailboxMessageValidator;
...
public class MailboxMessageService {
  ...
  public static final String MAILBOX_LOG_NOT_FOUND = "Mailbox Log with id %d not found";
  public static final String APPLICATION_NOT_LINKED = "Application was not linked to the Mailbox Message";
  public static final String PROFILE_NOT_LINKED = "Profile was not linked to the Mailbox Message";

  private final MailboxMessageRepository mailboxMessageRepository;

  private final ApplicationService2 applicationService;
  ...
  public MailboxMessage getMailboxMessageById(Long id) {
    ...
    return mailboxMessageRepository.findById(id).orElseThrow(() ->
      new EntityNotFoundException(MAILBOX_LOG_NOT_FOUND.formatted(id))
    );
  }
  ...
  public MailboxMessage createMailboxMessage(MailboxMessage mailboxMessage) {
    ...
    mailboxMessage.setReceiver(profile[0].getEmail());
