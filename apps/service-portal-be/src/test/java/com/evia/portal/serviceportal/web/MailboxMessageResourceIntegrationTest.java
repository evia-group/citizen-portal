...
import com.evia.portal.serviceportal.core.domain.enumeration.*;
import com.evia.portal.serviceportal.core.dto.*;
import com.evia.portal.serviceportal.core.repository.*;
import com.evia.portal.serviceportal.web.mapper.ApplicationMapper;
import com.evia.portal.serviceportal.web.mapper.LocationMapper;
import com.evia.portal.serviceportal.web.mapper.ProfileMapper;
...
class MailboxMessageResourceIntegrationTest {
  ...
  void createMailboxMessageTest_ThenReturnFoundMailboxMessages() throws Exception {
    ...
    assertThat(mailboxLog).usingRecursiveComparison().ignoringFields("sendAt", "id", "receiver").isEqualTo(consentToSave);
