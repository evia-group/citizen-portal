...
>(({ className, ...props }, ref) => {
  ...
  return (
    <DialogPrimitive.Overlay
      className={cn(
        "web:fixed web:inset-0 z-50 bg-black/80 flex justify-center items-center p-2",
        open
...
>(({ className, children, ...props }, ref) => {
  return (
    ...
    >
      ...
      >
        {/* biome-ignore lint/complexity/noUselessFragments: copied from react-native-reusable */}
        <>{children}</>
      </Animated.View>
    </DialogPrimitive.Overlay>
  );
